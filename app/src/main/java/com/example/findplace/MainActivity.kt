...
class MainActivity : AppCompatActivity() {
    ...
    private val showKakaoMapListener = View.OnClickListener {
        ...
        mapView.setPOIItemEventListener(MarkerEventListener(this@MainActivity))
        mapView.setCalloutBalloonAdapter(CustomBalloonAdapter(layoutInflater, this@MainActivity))
